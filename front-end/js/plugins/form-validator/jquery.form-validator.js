...
(function($) {
    ...
    */
    ...
    $.formUtils = {
        ...
        * 
        * rewroted function by Zoltan Csontos
        * @dependency - date-format.js
        * @param {String} val
        * @param {String} dateFormat
        * @return {Array}|{Boolean}
        */
        parseDate : function(val, dateFormat) {
            var valToDate = new Date(val),
                year = valToDate.getFullYear(),
                month = valToDate.getMonth(),
                day = valToDate.getDay(),
                formated = "";
            if (valToDate != "Invalid Date" && val !== "") {
                formated = valToDate.format(dateFormat);
                if (formated == val) {
                    return true;
                }
            }
